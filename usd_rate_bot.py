...
ID_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "usd_msg_id.txt")
...
def main() -> None:
    ...
    if message_id is None:
        ...
        print(f"USD_MESSAGE_ID = {message_id}  <-- запомни это значение")
    else:
